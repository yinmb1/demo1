package yy.demo.demo1.lambda.map;
    ...
    List<Person> javaProgrammers = new ArrayList<Person>() {
        {
            ...
            add(new Person("Shawn", "Randall", "Java programmer", "male", 31, 2300));
    ...
    List<Person> phpProgrammers = new ArrayList<Person>() {
        {
            ...
            add(new Person("Quinn", "Tamara", "PHP programmer", "female", 20, 1000));
