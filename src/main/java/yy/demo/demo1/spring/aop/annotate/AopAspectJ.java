package yy.demo.demo1.spring.aop.annotate;
...
public class AopAspectJ {
     ...
     */
    public static final String EDP="execution(* yy.demo.demo1.spring.aop.xml.UserManagerServiceImpl..*(..))";
